...
class AuthenticationRepository extends GetxController {
  ...
  Future<String?> createUserWithEmailAndPassword(
    ...
    try {
      ...
      //throw ex;
      return SignUpWithEmailAndPasswordFailure.code(e.code).message;
    } catch (_) {
      //const ex = SignUpWithEmailAndPasswordFailure();
      //print('EXCEPTION - ${ex.message}');
      //throw ex;
      return const SignUpWithEmailAndPasswordFailure().message;
    }
    return null;
  }
  ...
  Future<String?> loginWithEmailAndPassword(String email, String password) async {
    try {
      ...
      return SignInWithEmailAndPasswordFailure.code(e.code).message;
    } catch (_) {
      return const SignInWithEmailAndPasswordFailure().message;
    }
    return null;
  }
