...
class TTextTheme {
  ...
  static TextTheme lighTextTheme = TextTheme(
    ...
    headline4: GoogleFonts.poppins(fontSize: 20.0, fontWeight: FontWeight.w600, color: tDarkColor,),
    headline5: GoogleFonts.poppins(fontSize: 16.0, fontWeight: FontWeight.w600, color: tDarkColor,),
    headline6: GoogleFonts.poppins(fontSize: 14.0, fontWeight: FontWeight.w500, color: tDarkColor,),
    bodyText1: GoogleFonts.poppins(fontSize: 14.0, fontWeight: FontWeight.normal, color: tDarkColor,),
    bodyText2: GoogleFonts.poppins(fontSize: 12.0, fontWeight: FontWeight.normal, color: tDarkColor,),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headline4: GoogleFonts.poppins(fontSize: 20.0, fontWeight: FontWeight.w600, color: tWhiteColor,),
    headline5: GoogleFonts.poppins(fontSize: 16.0, fontWeight: FontWeight.w600, color: tWhiteColor,),
    headline6: GoogleFonts.poppins(fontSize: 14.0, fontWeight: FontWeight.w500, color: tWhiteColor,),
    bodyText1: GoogleFonts.poppins(fontSize: 14.0, fontWeight: FontWeight.normal, color: tWhiteColor,),
    bodyText2: GoogleFonts.poppins(fontSize: 12.0, fontWeight: FontWeight.normal, color: tWhiteColor,),
  );
}
